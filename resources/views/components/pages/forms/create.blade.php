<form action="{{ route('pages.store') }}" method="POST" id="createPageForm">
    ...
    <div class="block mt-4">
        <label for="is_public" class="block font-medium text-sm text-gray-700 dark:text-gray-300">
            <x-checkbox id="is_public" name="is_public" value="1" />
    ...
    <div class="block mt-4">
        <label for="is_accept_version" class="block font-medium text-sm text-gray-700 dark:text-gray-300">
            <x-checkbox id="is_accept_version" name="is_accept_version" value="1" />
