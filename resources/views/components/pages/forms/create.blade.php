<form action="{{ route('pages.store') }}" method="POST">
    ...
    <div class="mt-4">
        <fieldset>
            ...
            <input type="text" name="title" id="title" value="{{ old('title') }}" aria-describedby="title-explanation" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm dark:bg-gray-700 dark:text-gray-200 dark:border-gray-700 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
    ...
    <div class="mt-4">
        <fieldset>
            ...
            <input type="text" name="tags" id="tags" aria-describedby="tags-explanation" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm dark:bg-gray-700 dark:text-gray-200 dark:border-gray-700 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
